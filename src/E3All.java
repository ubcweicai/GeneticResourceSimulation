...
public class E3All {
	...
	public static void main (String args[])
	{
		...
		{
			for(double cc_p_i=1; cc_p_i<=1; cc_p_i++)
			{	
				cc_p=cc_p_i/10;
...
//								{
									...
									saveAllToFile(avr.cloudConsumption, avr.averageDeviceBandwidth, avr.averageDeviceConsumption, "all_result", ComponentQuantity);
