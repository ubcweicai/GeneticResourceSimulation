...
public class E1 {
	...
	public static void main (String args[])
	{
		...
		for(double cc_p_i=1; cc_p_i<=10; cc_p_i++)
		{
			...
			for(MobileDeviceQuantity=MobileDeviceQuantityStart; MobileDeviceQuantity<=maxMobileDeviceQuantity; MobileDeviceQuantity++)
			{
				...
				for(int simu_time=0; simu_time<SimulationTimes; simu_time++)
				{
					...
					{
						terminal.add(String.format("%.2f",allCloudValidResult.averageDeviceBandwidth));
					...
					{
						network.add(String.format("%.2f",minValidResult_throughput.averageDeviceBandwidth));
					...
					{
						cloud.add(String.format("%.2f",minValidResult_cloud.averageDeviceBandwidth));
					...
					if(minValidResult_throughput!=null)
					{
						delay.add(String.format("%.2f",minValidResult_Latency.averageDeviceBandwidth));
		...
		saveToFile(terminal, network, cloud, delay, communicationProbability, degreeVariance, "network_result");
