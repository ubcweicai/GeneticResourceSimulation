...
public class E5OverallCostMaxMin_CQ {
	...
	public static void main (String args[])
	{
		...
		for(double cc_p_i=3; cc_p_i<=3; cc_p_i++)
		{
			cc_p=cc_p_i/10;	
		for(ComponentQuantity=6; ComponentQuantity<=14; ComponentQuantity++)
		{
			...
			for(int simu_time=0; simu_time<SimulationTimes; simu_time++)
			{
					...
					saveMaxMinToFile(write_MinOverallCost, write_MinOverallCost_Unlimited, write_MaxOverallCost, write_MaxOverallCost_Unlimited, write_ComponentQuantity, "maxmin_result_cq_all");
			}
		}
		}
		/*
	...
	public static void saveMaxMinToFile(String write_MinOverallCost, String write_MinOverallCost_Unlimited, String write_MaxOverallCost, String write_MaxOverallCost_Unlimited, int componentQuantity,  String filename)
	{
		...
		try{
			...
			dos.writeBytes(componentQuantity+"\r");
